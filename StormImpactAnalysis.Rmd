...
**Floods** caused the most Total Damage (*Graph #3*). 
```{r}
print(plot3)
```

**Floods** also cause the most in Total Property Damage (*Graph #4*)
```{r}
print(plot4)
```

However, **Droughts** cause the Most Crop Damage (*Graph #3*)
```{r}
print(plot5)
```
